...
defmodule OtpEsTest do
 ...
 #  end
  ...
  test "Aggregate" do
       ...
       assert %Model.Counter.Create{aggregate_id: "agg_id"}
      |> OtpEs.CommandService.execute() == :ok
       assert %Model.Counter.Create{aggregate_id: "agg_id2"}
      |> OtpEs.CommandService.execute() == :ok
       assert %Model.Counter.Create{aggregate_id: "agg_id3"}
      |> OtpEs.CommandService.execute() == :ok
      ...
      |> OtpEs.CommandService.execute() == {:error, "Already created"}
       ...
       assert %Model.Counter.Increment{aggregate_id: "agg_id"}
      |> OtpEs.CommandService.execute() == :ok
